...
export default function EntradasPage() {
  ...
  const aplicarArchivoFacturaDesde =
    ...
    (e: ChangeEvent<HTMLInputElement>) => {
      ...
      logFacturaMovil('usa', 'DEBUG: onChange handler', { origenInput });
  ...
  useEffect(() => {
    logFacturaMovil('usa', 'DEBUG: refs input file tras montaje', {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(
        '[entradas-usa][DIAG guardado] Comparativa formulario vs parse (ver consola servidor para payload SQL)',
        JSON.stringify(
          {
            notaUI:
              ...
              <div style={{ display: 'flex', gap: 10, marginBottom: 10 }}>
                ...
                >
                  ...
                  <input
                    ...
                    onClick={() => {
                      logFacturaMovil('usa', 'DEBUG: clic en input file galería (overlay)');
                      logFacturaMovil('usa', 'DEBUG: ref galería en click', {
                ...
                >
                  ...
                  <input
                    ...
                    onClick={() => {
                      logFacturaMovil('usa', 'DEBUG: clic en input file cámara (overlay)');
                      logFacturaMovil('usa', 'DEBUG: ref cámara en click', {
